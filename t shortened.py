...
race_mapping = {
    '/explanation Tiefling': 0,
    '/explanation Dwarf': 1,
    '/explanation Gnome': 2,
    '/explanation Elf': 3,
    '/explanation Half_Elf': 4,
    '/explanation Halfling': 5,
    '/explanation Half_Orc': 6,
    '/explanation Human': 7,
    '/explanation Dragonborn': 8,
    '/details Tiefling': 0,
    '/details Dwarf': 1,
    '/details Gnome': 2,
    '/details Elf': 3,
...
while Race_exinput.startswith("/explanation" or "/details"):
    index = race_mapping.get(Race_exinput)
    if index is not None:
        if '/explanation' in Race_exinput:
            print(Races[index]["explanation"])
        elif '/details' in Race_exinput:
            print(Races[index]["details"]["Attribute_Bonus"])
...
if character_race_input == 'tiefling' or "Tiefling":
    ...
    Elf_subrace_exinput = str(input("Elfs are the race with the most subclasses, but im gonna"))
